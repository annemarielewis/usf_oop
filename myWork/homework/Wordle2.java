...
public class Wordle2 {
    ...
    public static void testGetFileHandle() {
        ...
        System.out.print(
                "Sorry bogus was not found! That's bogus! ;( But to confirm: please enter the filename you'd like to open and have a random word selected from! :) ");
        ...
        if (fileScanner != null) {
            System.out.println("Successfully opened: " + filename + " here are the contents of " + filename);
